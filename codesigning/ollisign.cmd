...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
::: 2011..19, Oliver Schneider (assarbad.net) - Released into the PUBLIC DOMAIN.
::: (Alternatively under CC0 in jurisdictions where public domain dedications
:::  by living individuals are not accepted.)
:::
...
:: Look for the newest Visual Studio we can find
set VCVER_FRIENDLY=
"%SIGNTOOL%" /? >NUL 2>NUL || call setvcvars.cmd
:: > NUL 2>&1
set SIGNTOOL=signtool.exe
:: Fallback #1: Check if that succeeds and look for Windows 8.1 SDK (x64) otherwise
"%SIGNTOOL%" /? >NUL 2>NUL || set SIGNTOOL=%ProgramFiles(x86)%\Windows Kits\8.1\bin\x64\signtool.exe
:: Fallback #2: Check if that succeeds and look for Windows 8.1 SDK (x86) otherwise
...
set SIGNCMD="%SIGNTOOL%" sign /v /debug /a %IDENTIFIER% /ph
...
set SIGNCMD=%SIGNCMD%
echo SHA2ONLY=%SHA2ONLY%
if not defined SHA2ONLY set APPENDSIG= /as
:: Now sign ...
@echo on
